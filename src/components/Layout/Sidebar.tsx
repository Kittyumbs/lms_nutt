...
import { CheckSquareOutlined, BookOutlined, AppstoreOutlined, BarChartOutlined, FileTextOutlined, MenuOutlined, UserOutlined, SwapOutlined } from '@ant-design/icons';
...
export default function Sidebar() {
  ...
  const { isSignedIn, handleAuthClick, signOut, isAuthLoading, userProfile } = useGoogleCalendar();
                ...
                <>
                  <div className="ml-2 flex-1 overflow-hidden">
                    ...
                    <div className="text-xs text-gray-500 truncate">
                      {userProfile?.email || 'Đã đăng nhập'}
                    </div>
                  </div>
                  <Button
                    type="text"
